...
const regularExpressions = {
  ...
  email: /^[a-zA-Z0-9_.+-]+@misena.edu.co+$/,
...
const validateField = function (expression, input, field) {
  ...
  const message = document.querySelector(`#group-${field} .step__field-error`).classList;
...
const validatePass = function () {
  ...
  const message = document.querySelector(`#group-confirm-pass .step__field-error`).classList;
