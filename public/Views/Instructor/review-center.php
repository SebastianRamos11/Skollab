        ...
        <?php
          ...
          ?>
            ...
            <div class="activities-course activities-course<?php echo $i; ?> hidden">
              <div class="activities-course__label">Selecciona la evidencia a consultar</div>
              <hr>
              <?php 
                ...
                for($j=0; $j < sizeof($activities_array); $j++){
                  ...
                  ?>
                    ...
                    <div class="evidences-<?php echo $i; ?>-<?php echo $j; ?> evidences evidences-activity hidden">
                        ...
                        <!-- LABEL EVIDENCIAS-->
                        <div class="evidences-course__label">Elige la evidencia a calificar</div>
                        <hr>
                        <?php 
                        ...
                        <?php
                          ...
                          ?>
                          <div class="good-message"><i class="fa-solid fa-check"></i> No hay evidencias por calificar.</div>
                          <?php
                        }
                        ?>
                    </div>
