...
<html lang="es">
  ...
  <body id="body">
    ...
    <?php
      ...
      function roleOption($role, $figure, $num, &$aux){
        echo '
    ...
    <div class="roles">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php
              generateCrud($admin, 'Administradores', $num_crud);
            ?>

            <!-- CRUD: Instructores -->
            <?php
              generateCrud($instructor, 'Instructores', $num_crud);
            ?>

            <!-- CRUD: Aprendices -->
            <?php
              generateCrud($aprendiz, 'Aprendices', $num_crud);
            ?>
          </div>
        </div>
      </div>
