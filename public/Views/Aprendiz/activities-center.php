      ...
      <div>
        <?php
            ...
            for($j = 0; $j < sizeof($course); $j++){
              ...
              $act = "SELECT ID_Actividad, asunto, fecha FROM `actividad` WHERE ID_Ficha = $group AND ID_Persona = $id_instructor";
                    ...
                    <div class="activities">
                      <?php
                        for($k=0; $k < sizeof($pending); $k++){
                          ...
                          $activity = "SELECT AC.ID_Actividad, AC.asunto, AC.descripcion, AC.fecha, AC.fecha_limite, AC.url FROM actividad AC JOIN ambiente_virtual A ON AC.ID_Persona = A.ID_Persona WHERE AC.ID_Ficha = $group AND AC.ID_Actividad = $id_activity;";
                          ...
                          <div class="activity">
                            ...
                            <div class="activity__btns">
                              <a href="activity.php?group=<?php echo $group ?>&activity=<?php echo $activity_array[0][0]?>" class="activity__btns-link">Entregar>></a>
                            </div>
                          </div>
                          <?php
                        }
